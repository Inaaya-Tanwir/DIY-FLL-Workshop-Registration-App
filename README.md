...
bashgit clone https://github.com/Inaaya-Tanwir/AI-FLL-DIY-.git
cd AI-FLL-DIY-
...
jsximport WorkshopApp from './WorkshopApp';
...
Enter your FLL team number (numbers only, e.g., 70511)
Confirm your team when prompted
Receive your kit assignment - note which kit you've been assigned
Pick up your kit at the workshop table

For Administrators

Click "Admin Login" at the bottom of the registration screen
Enter password: STEM20FOREVER26
Access the dashboard with full controls:
...
🎁 Available Kits
Kit TypeEmojiProvided ByQuantityArduino Vibe Coding Kit💡Team 7051120DIY Robot Kit🤖Team 7069520DIY STEM Gadget⚙️Team 7107620
...
Shared Storage: All data stored with shared: true flag
Auto-polling: Every device checks for updates every 2 seconds
Instant Updates: Changes made on any device appear on all devices
No Backend Required: Storage handled by Claude's infrastructure
...
Click "Reset Data" in admin dashboard
Type confirmation code: RESET2026
Click "Confirm Reset"
